...
export default function StackHeader({ route }: { route: string }) {
   return (
      <View style={{ ...darkStyles.container, position: "relative" }} className="pb-3 flex flex-row justify-center items-center">
         <Link href=".." style={{ position: "absolute", top: 0, left: 0 }}>
            <MaterialIcons name="arrow-back" size={32} color="gray" />
         </Link>
